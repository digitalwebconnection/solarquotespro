...
export default function WhyChooseUs() {
  return (
    <section className="py-16 lg:py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[40rem] h-[40rem] bg-amber-50 rounded-full blur-[120px] opacity-60 pointer-events-none transform translate-x-1/3 -translate-y-1/3" />
      <div className="absolute bottom-0 left-0 w-[40rem] h-[40rem] bg-emerald-50 rounded-full blur-[120px] opacity-60 pointer-events-none transform -translate-x-1/3 translate-y-1/3" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-xs font-bold tracking-[0.2em] uppercase text-amber-600">Trusted by Homeowners</span>
            </div>
            ...
            <div className="space-y-4 text-base lg:text-lg text-slate-600 leading-relaxed mb-8">
              <p>
            ...
            <div className="space-y-4 pt-6 border-t border-slate-100">
              {[
                ...
                >
                  ...
                  <p className={`font-bold text-base lg:text-lg leading-tight pt-1 ${item.muted ? 'text-slate-600' : 'text-slate-900'}`}>
                    {item.text}
                  </p>
                </motion.div>
              ))}
          ...
          >
            ...
            <div className="relative w-full p-8 lg:p-10">
              ...
              <div className="space-y-5 relative">
                ...
                {/* Card 1 */}
                <div className="relative bg-white rounded-md p-6 shadow-md shadow-slate-200/40 border border-slate-100 border-l-4 border-l-emerald-500 flex flex-col sm:flex-row items-start gap-5 sm:ml-0 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-emerald-200 group">
                  <div className="w-12 h-12 rounded-md bg-emerald-50 flex items-center justify-center flex-shrink-0 group-hover:bg-emerald-100 transition-colors shadow-sm border border-emerald-100/50">
                ...
                {/* Card 2 */}
                <div className="relative bg-white rounded-md p-6 shadow-md shadow-slate-200/40 border border-slate-100 border-l-4 border-l-blue-500 flex flex-col sm:flex-row items-start gap-5 sm:ml-6 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-blue-200 group z-10">
                  <div className="w-12 h-12 rounded-md bg-blue-50 flex items-center justify-center flex-shrink-0 group-hover:bg-blue-100 transition-colors shadow-sm border border-blue-100/50">
                ...
                {/* Card 3 */}
                <div className="relative bg-white rounded-md p-6 shadow-md shadow-slate-200/40 border border-slate-100 border-l-4 border-l-amber-500 flex flex-col sm:flex-row items-start gap-5 sm:ml-12 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-amber-200 group z-20">
                  <div className="w-12 h-12 rounded-md bg-amber-50 flex items-center justify-center flex-shrink-0 group-hover:bg-amber-100 transition-colors shadow-sm border border-amber-100/50">
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -right-2 sm:-right-6 bg-white rounded-md shadow-xl p-4 border border-slate-100 flex flex-col sm:flex-row items-center gap-4 z-30"
              >
