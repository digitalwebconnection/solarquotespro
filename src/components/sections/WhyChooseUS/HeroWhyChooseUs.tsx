...
const HeroWhyChooseUs = () => {
  ...
  <div className="max-w-3xl mx-auto px-5 text-center">
    ...
    <button
    onClick={() => openQuoteModal()} className="mt-8 px-6 py-3 rounded-lg bg-linear-to-r from-emerald-500 to-emerald-400 text-white font-bold cursor-pointer hover:from-emerald-400 hover:to-emerald-500 active:scale-96 transition-all duration-300">Get Your Solar Quotes</button>
  </div>
</section>
    )
}
