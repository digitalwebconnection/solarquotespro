...
const SolarJourney = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-6 lg:py-8">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="inline-flex items-center justify-center gap-2 px-4 py-1.5 rounded-full bg-slate-900/90 border border-amber-500/40 text-amber-400 text-xs sm:text-sm font-bold tracking-wide uppercase mb-6 backdrop-blur-md shadow-lg shadow-amber-500/10"
        >
        ...
        <motion.h2 
          ...
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-black text-white mb-4 tracking-tight leading-[1.15]"
        >
        ...
        <motion.div 
          ...
          className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 max-w-5xl mx-auto mb-4 text-left"
        >
          {journeyMilestones.map((item, idx) => (
            <div 
              key={idx}
              className="bg-slate-900/80 backdrop-blur-md rounded-2xl p-4 border border-slate-800 hover:border-slate-700 transition-all flex items-center gap-3.5 shadow-xl shadow-black/40 group cursor-pointer"
              onClick={() => openQuoteModal()}
            >
              <div className="w-10 h-10 rounded-xl bg-slate-950 border border-slate-800 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                {item.icon}
              </div>
        ...
        >
          ...
          {/* Social Proof Badges */}
          <div className="flex items-center gap-3 bg-slate-900/80 backdrop-blur-md px-4 py-3.5 rounded-full border border-slate-800 text-xs">
