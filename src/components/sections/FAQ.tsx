      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6 relative z-10">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-serif font-black text-slate-900 mb-3 sm:mb-4 leading-tight tracking-tight">
              Frequently Asked <br />
              <span className="text-transparent bg-clip-text bg-linear-to-r from-amber-500 via-orange-500 to-amber-600 relative inline-block">
                Questions
                <svg className="absolute -bottom-1.5 left-0 w-full h-2 sm:h-2.5 text-orange-300" viewBox="0 0 100 10" preserveAspectRatio="none">
                  <path d="M0 5 Q 50 10 100 5" stroke="currentColor" strokeWidth="4" fill="none" />
                </svg>
              </span>
            </h2>

            <p className="text-sm sm:text-base text-slate-700 mb-6 sm:mb-8 leading-relaxed font-medium">
            ...
            <div className="relative bg-white rounded-2xl p-4 sm:p-6 border border-slate-200 shadow-xl shadow-slate-200/50 overflow-hidden group mb-6 lg:mb-0">
              ...
              <div className="relative z-10 flex items-start gap-3 sm:gap-4">
                <div className="relative">
                  <div className="w-11 h-11 sm:w-14 sm:h-14 bg-linear-to-tr from-amber-400 via-orange-400 to-orange-500 text-slate-950 rounded-xl sm:rounded-2xl flex items-center justify-center shrink-0 shadow-md font-black text-lg sm:text-xl">
                    ☀️
                  </div>
                  <span className="absolute -bottom-1 -right-1 w-3.5 h-3.5 sm:w-4 sm:h-4 bg-emerald-500 border-2 border-white rounded-full animate-pulse" />
                </div>

                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h4 className="font-bold text-slate-900 text-sm sm:text-base">Still have questions?</h4>
                    <span className="text-[9px] sm:text-[10px] font-black uppercase text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded-full">Live</span>
                  </div>
                  ...
                  <button 
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 bg-slate-950 hover:bg-slate-800 text-white text-xs sm:text-sm font-bold py-2.5 sm:py-3 px-4 sm:px-5 rounded-xl transition-all shadow-md hover:shadow-lg cursor-pointer active:scale-98"
                  >
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left p-3.5 sm:p-5 group cursor-pointer"
                  >
                    <div className="flex items-center gap-3 sm:gap-5 flex-1 min-w-0 pr-2">
                      <div className={`w-8 h-8 sm:w-9 sm:h-9 rounded-lg sm:rounded-xl flex items-center justify-center shrink-0 border transition-colors ${
                        isOpen 
                    ...
                    <div className={`shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-lg sm:rounded-xl flex items-center justify-center transition-all ${
                  ...
                  <AnimatePresence>
                    {isOpen && (
                      ...
                      >
                        <div className="px-4 sm:px-6 pb-4 sm:pb-6 pt-1 text-slate-700 text-xs sm:text-sm md:text-base leading-relaxed pl-13 sm:pl-19 border-t border-slate-100/80">
                          {faq.answer}
                        </div>
                      </motion.div>
                    )}
