        ...
        <section className="relative h-auto inset-0 w-full overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 h-auto">
                <div className="max-w-3xl text-white space-y-8 mt-9">
                    ...
                    <h1 className="max-w-3xl text-3xl sm:text-5xl lg:text-6xl font-bold font-serif leading-17 tracking-tight">Explore & Compare{" "}
                        <span className="bg-linear-to-r from-yellow-300 from-60% to-green-400 bg-clip-text text-transparent">Home Energy Solutions</span>
                    </h1>

                    <p className="text-lg text-white/90 font-semibold -mt-5"> From solar panels and home batteries to EV chargers,hot-water heat pumps and more, discover your options,compare trusted providers and find the right energy solution for your home.
                    </p>

                    <button type="button" onClick={() => openQuoteModal()} className="bg-linear-to-r from-yellow-500 to-orange-500 text-white font-bold text-base py-2 px-5 rounded-full transition-all shadow-md hover:shadow-lg inline-flex items-center gap-2 cursor-pointer mt-3 mb-3 active:scale-97 group">
