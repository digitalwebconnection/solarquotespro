    ...
    <section className="relative py-14 bg-slate-50 ">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center max-w-3xl mx-auto mb-14">
          <h1 className="text-3xl sm:text-4xl font-extrabold mt-2 font-serif bg-linear-to-r from-amber-500 from-40% to-blue-800 bg-clip-text text-transparent">How Does a Home Battery Work?</h1>

          <p className="text-lg text-slate-700 font-semibold leading-7 mt-5"> A home battery stores electricity so it can be used when you need it most. During the day, your solar panels can produce more electricity than your home needs. Instead of sending all that excess energy to the grid, the battery can store it for later.
          </p>
        </div>

        <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="space-y-4">
            <h2 className="text-3xl font-extrabold font-serif text-blue-700 mb-6 border-b-3 border-blue-700   inline-flex ">Battery Components</h2>
            <div className="group">
            ...
            <div className="group">
              <h3 className="text-xl font-serif font-bold mb-1 text-slate-900 group-hover:text-orange-500"> Separator </h3>
              <p className="leading-7 text-slate-700"> A thin insulating layer that keeps the electrodes apart while
                allowing ions to pass through. </p>
            </div>
          </div>

          <div className="flex justify-center">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2Gd_kkaarPArbaNjs7XCI6AJDUZ5YHwh9DuNfOTO24Q&s=10" className="rounded-2xl shadow-xl" alt="Home battery" />
          </div>
