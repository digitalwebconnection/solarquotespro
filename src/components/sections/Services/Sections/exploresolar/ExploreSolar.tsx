...
export default function ExploreSolar() {
  ...
  return (
    <section className="relative h-screen  w-full overflow-hidden " id="solar">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-7 py-1 sm:py-14 lg:py-16">
        <div className="max-w-3xl text-white space-y-5">
          ...
          <p className="text-base sm:text-lg text-slate-200 font-medium text-justify leading-relaxed max-w-2xl">
