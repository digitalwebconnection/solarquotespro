  ...
  return (
    <section className="py-8 lg:py-14 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden bg-linear-to-br from-[#00417E] via-[#002e5b] to-slate-950 border border-slate-800 rounded-2xl sm:rounded-3xl p-5 sm:p-8 md:p-12 shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 sm:gap-10">
            ...
            <div className="flex-1">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-black text-white tracking-tight mb-3 sm:mb-4 leading-tight">
                Ready To Compare Solar Quotes?
              </h2>

              <div className="space-y-1 text-sm sm:text-base md:text-lg text-slate-200 font-medium">
                <p>
            ...
            <div className="shrink-0 w-full lg:w-auto flex flex-col items-center">
              <button 
                ...
                className="bg-[#F9B122] hover:bg-[#eab308] text-[#00417E] font-black text-base sm:text-lg py-3.5 sm:py-4 px-8 sm:px-10 rounded-full transition-all shadow-[0_10px_35px_rgba(249,177,34,0.45)] hover:shadow-[0_15px_45px_rgba(249,177,34,0.6)] w-full mb-2 sm:mb-3 cursor-pointer hover:scale-105 active:scale-100 text-center"
              >
                Get 3 Free Quotes
              </button>
