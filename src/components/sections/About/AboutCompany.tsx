    ...
    return (
        <section className="py-14 bg-slate-50">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-x-12 px-4 py-7 sm:px-6 lg:px-8">
                ...
                {/* Content */}
                <div>
                    <h1 className="text-3xl font-extrabold text-blue-900 font-serif">
                        About Our Company
                    </h1>
                ...
                <div className="relative flex items-center min-h-100">
                    <div className="absolute -top-15 -left-20 w-90 h-80 bg-blue-800/40 rounded-full blur-[120px]">
                    </div>

                    <img src="https://www.solarquotes.com.au/wp-content/uploads/2024/01/solarquotes-team.jpg"
                        alt="Solar panels on an Australian home" className="absolute z-1 rounded-lg shadow-xl shadow-slate-600 w-full h-90 object-cover"
                    />
                </div>
