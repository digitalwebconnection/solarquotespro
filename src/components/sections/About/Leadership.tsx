    ...
    <section className="bg-slate-950 py-20 text-white relative timeline-view animate-blurred-fade-in animate-range-[entry_20%_contain_100%]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-4">
          {leaders.map((item) => (
            <div key={item.name} className={`bg-slate-900 border rounded-2xl overflow-hidden flex flex-col  transition-all duration-300 shadow-xl  ${
                item.isMiddle ? "-translate-y-7 border-amber-400/40 shadow-amber-500/10"
