...
const SolarCalculatorPromo = () => {
  return (
    <section className="calculator-promo mb-20 bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-3xl p-10 md:p-16 flex flex-col md:flex-row items-center justify-between shadow-2xl relative overflow-hidden">
