    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 font-sans text-gray-800">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <section className="hero bg-gradient-to-r from-blue-700 to-cyan-600 text-white py-20 px-4 md:px-8 rounded-xl mb-12 shadow-lg text-center">
      ...
      <section className="mb-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={cat} className="bg-white p-8 border border-gray-200 rounded-xl hover:shadow-xl hover:border-blue-300 transition-all cursor-pointer group text-center">
